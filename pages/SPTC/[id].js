...
import SPTCValidator from '@/validators/SPTCValidator'
...
const form = () => {
    ...
    useEffect(() => {
        if (query.id) {
            axios.get('/api/SPTC/' + query.id).then(resultado => {
                const SPTC = resultado.data

                for (let atributo in SPTC) {
                    setValue(atributo, SPTC[atributo])
                }
            })
        }
    }, [query.id])
    ...
    function salvar(dados) {
        axios.put('/api/SPTC/' + query.id, dados)
        push('/SPTC')
    }
            ...
            <Form>
                <Form.Group className="mb-3" controlId="nome">
                    ...
                    <Form.Control
                        ...
                        {...register('nome', SPTCValidator.nome)} />
                    {
                        errors.nome &&
                ...
                <Form.Group className="mb-3" controlId="CPF">
                    ...
                    <Form.Control
                        ...
                        mask='999.999.999-99'
                        {...register('CPF', SPTCValidator.CPF)}
                ...
                <Form.Group className="mb-3" controlId="email">
                    ...
                    <Form.Control
                        ...
                        {...register('email', SPTCValidator.email)} />
                    {
                        errors.email &&
                ...
                <div className='text-center'>
                    ...
                    <Link className="ms-2 btn btn-danger" href="/SPTC">
