...
import PMERJValidator from '@/validators/PMERJValidator'
...
const form = () => {
    ...
    useEffect(() => {
        if (query.id) {
            axios.get('/api/PMERJ/' + query.id).then(resultado => {
                const PMERJ = resultado.data

                for (let atributo in PMERJ) {
                    setValue(atributo, PMERJ[atributo])
                }
            })
        }
    }, [query.id])
    ...
    function salvar(dados) {
        axios.put('/api/PMERJ/' + query.id, dados)
        push('/PMERJ')
    }
            ...
            <Form>
                <Form.Group className="mb-3" controlId="nome">
                    ...
                    <Form.Control
                        ...
                        {...register('nome', PMERJValidator.nome)} />
                    {
                        errors.nome &&
                ...
                <Form.Group className="mb-3" controlId="CPF">
                    ...
                    <Form.Control
                        ...
                        mask='999.999.999-99'
                        {...register('CPF', PMERJValidator.CPF)}
                ...
                <Form.Group className="mb-3" controlId="email">
                    ...
                    <Form.Control
                        ...
                        {...register('email', PMERJValidator.email)} />
                    {
                        errors.email &&
                ...
                <div className='text-center'>
                    ...
                    <Link className="ms-2 btn btn-danger" href="/PMERJ">
