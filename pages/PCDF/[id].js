...
import PCDFValidator from '@/validators/PCDFValidator'
...
const form = () => {
    ...
    useEffect(() => {
        if (query.id) {
            axios.get('/api/PCDF/' + query.id).then(resultado => {
                const PCDF = resultado.data

                for (let atributo in PCDF) {
                    setValue(atributo, PCDF[atributo])
                }
            })
        }
    }, [query.id])
    ...
    function salvar(dados) {
        axios.put('/api/PCDF/' + query.id, dados)
        push('/PCDF')
    }
            ...
            <Form>
                <Form.Group className="mb-3" controlId="nome">
                    ...
                    <Form.Control
                        ...
                        {...register('nome', PCDFValidator.nome)} />
                    {
                        errors.nome &&
                ...
                <Form.Group className="mb-3" controlId="CPF">
                    ...
                    <Form.Control
                        ...
                        mask='999.999.999-99'
                        {...register('CPF', PCDFValidator.CPF)}
                ...
                <Form.Group className="mb-3" controlId="email">
                    ...
                    <Form.Control
                        ...
                        {...register('email', PCDFValidator.email)} />
                    {
                        errors.email &&
                ...
                <div className='text-center'>
                    ...
                    <Link className="ms-2 btn btn-danger" href="/PCDF">
